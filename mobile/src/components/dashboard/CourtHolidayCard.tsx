...
interface CourtHolidayCardProps {
...
const CourtHolidayCard: React.FC<CourtHolidayCardProps> = ({
  holidays,
  loading,
  error,
}) => {
            ...
            <React.Fragment key={holiday.id}>
              <View style={styles.holidayRow}>
                ...
                <View style={styles.holidayContent}>
                  ...
                  <Text style={styles.holidayDate} numberOfLines={1}>
                    {holiday.day}, {holiday.date}
                  </Text>
                  <Text style={styles.holidayCourt} numberOfLines={1}>
                    {holiday.court}
                  </Text>
                </View>
              </View>
              {index < holidays.slice(0, 3).length - 1 && (
...
export default CourtHolidayCard;
...
export default function RevenueCourtScreen() {
    ...
    <ScrollView contentContainerStyle={styles.container}>
      <GlassCard borderColor="rgba(181, 141, 61, 0.35)" accent="#B58D3D">
        <View style={styles.headerRow}>
          ...
          <View style={{ flex: 1 }}>
            <Text style={styles.title}>Revenue Court • Phase 8</Text>
            <Text style={styles.subtitle}>
              SDM, Tehsildar, Collector, Revenue Court, Land Mutation, Partition,
              Demarcation, Jamabandi, Khasra, Khatauni
            </Text>
          </View>
        </View>
      ...
      <View style={styles.cards}>
        {topics.map((t) => (
          <Pressable
            ...
            onPress={() => router.push(`/revenue-court/${t.key}` as any)}
          >
